...
class StanzaTest {
	...
	void setUp() {
		...
		this.vuota.impostaStanzaAdiacente(Direzione.sud, unAttrezzo);
		this.unAttrezzo.impostaStanzaAdiacente(Direzione.nord, vuota);
	...
	void testNumeroStanzeAdiacenti() {
		...
		this.vuota.impostaStanzaAdiacente(Direzione.est, scema);
		assertTrue(this.vuota.getNumeroStanzeAdiacenti()==2);
	}

	@Test
	void testGetStanzeAdiacenti() {
		assertEquals(unAttrezzo, vuota.getStanzaAdiacente(Direzione.sud));
		assertEquals(vuota, unAttrezzo.getStanzaAdiacente(Direzione.nord));
	}
