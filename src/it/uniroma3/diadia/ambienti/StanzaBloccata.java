...
public class StanzaBloccata extends Stanza{
	...
	public String getDescrizione() {
		...
		String Bloccata = "Ma non nella direzione " + this.direzioneBloccata
				+ ".\nSe vuoi sbloccare la direzione "+ this.direzioneBloccata+ ", devi prendere: " + this.passePartTout;
		
		StringBuilder risultato = new StringBuilder();
		risultato.append(super.getNome());
		risultato.append("\nPuoi andare: \n");
		
		for(Iterator<Direzione> it = super.getDirezioni().iterator(); it.hasNext();) {
			Direzione tmp = it.next();
