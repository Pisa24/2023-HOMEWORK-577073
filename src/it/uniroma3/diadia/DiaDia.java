...
public class DiaDia {
	...
	public void gioca() throws Exception {
		...
		this.getPartita().setStanzaCorrente(this.getPartita().getLabirinto().getStanzaIniziale());
	...
	public static void main(String[] argc) throws Exception {
		...
		Labirinto labirinto = Labirinto.newBuilder("LabirintoxGiocare").getLabirinto();
